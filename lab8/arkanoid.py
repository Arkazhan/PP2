...
collision_sound = pygame.mixer.Sound('lab8/arkan/catch (1).mp3')
unbreak_sound = pygame.mixer.Sound('lab8/arkan/unbreak.mp3')
...
unbreakable_brick_chance = 0.2 
perk_brick_chance = 0.1 
