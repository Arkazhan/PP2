...
background = pygame.image.load("lab8/carrace/AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("lab8/carrace/Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("lab8/carrace/Player.png")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("lab8/carrace/coin.png")
        self.rect = self.image.get_rect()
...
while not done:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound("lab8/carrace/crash.wav")
        time.sleep(1)
