...
background = pygame.image.load("carrace/AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("carrace/Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("carrace/Player.png")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("carrace/coin.png")
        self.rect = self.image.get_rect()
...
while not done:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound("carrace/crash.wav")
        time.sleep(1)
